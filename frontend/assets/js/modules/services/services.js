...
const comboManager = {
  ...
  setupComboFormListeners() {
    ...
    document.getElementById('selectedServicesContainer')?.addEventListener('click', (e) => {
    ...
    const form = document.getElementById('comboForm');
    if (form) {
      form.removeEventListener('submit', this.saveCombo.bind(this)); // Remove any existing listeners

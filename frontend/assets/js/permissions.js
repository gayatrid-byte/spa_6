...
const permissions = {
  ...
  getAvailableModules(userRole) {
    const modules = {
      owner: ['dashboard', 'staff', 'customers', 'services', 'bookings', 'calendar', 'billing', 'expenses', 'reports', 'memberships', 'memberships-add', 'settings'],
      center: ['dashboard', 'staff', 'customers', 'services', 'bookings', 'calendar', 'billing', 'expenses', 'reports', 'memberships', 'memberships-add', 'settings'],
      staff: ['dashboard', 'customers', 'bookings', 'reports', 'memberships']
    };

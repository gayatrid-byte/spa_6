...
async function loadModule(moduleName) {
  ...
  try {
    // Load module content
    const modulePath = `/assets/js/modules/${moduleName}/${moduleName}.js`;
...
function showModal(title, content, size = null) {
  ...
  // Reset size classes
  modalContent.classList.remove('modal-large', 'modal-full');
  if (size === 'large') {
    modalContent.classList.add('modal-large');
  } else if (size === 'full' || size === 'xl') {
    modalContent.classList.add('modal-full');
  }
